...
def update_graph_gradient(num, G, pos, node_sizes, ax):
    global count, injected_credit, ratio, alpha_middle, alpha_cental, alpha_small
    ...
    #         deg = G.degree(bank)
    #         print(f"Bank: {bank} has degree {deg}")
    #         if (deg <= 24):
    #             for i in range(1, 26):
...
ani_gradient = FuncAnimation(fig_gradient, update_graph_gradient, frames=50, interval=10000, fargs=(G_gradient, pos_gradient, node_sizes_gradient, ax_gradient))
